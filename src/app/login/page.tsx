    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-10">
      ...
      <div className="w-full max-w-sm bg-surface border rounded-card shadow-card p-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          {/* Sign in with Apple — obligatoire pour App Store iOS si autres OAuth presents */}
          <button onClick={() => { setLoading(true); signIn('apple', { callbackUrl: '/dashboard' }) }}
            disabled={loading}
            className="w-full flex items-center gap-3 bg-black hover:bg-zinc-900 text-white rounded-md px-4 py-3.5 transition-colors disabled:opacity-40">
