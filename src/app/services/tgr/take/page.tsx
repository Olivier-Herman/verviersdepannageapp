...
export default function TGRTakePage() {
  ...
  const [status,   setStatus]  = useState<'loading' | 'confirm' | 'success' | 'taken' | 'error'>('confirm')
        ...
        {status === 'success' && (
          <>
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm">
                Le demandeur a été notifié. Prenez contact avec lui pour coordonner la prise en charge.
              </p>
            </div>
            <button onClick={() => router.push('/services/tgr')}
        ...
        {status === 'taken' && (
          <>
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm">
                Un autre partenaire a été plus rapide. Cette mission n'est plus disponible.
              </p>
            </div>
            <button onClick={() => router.push('/services/tgr')}
              className="w-full py-3 bg-[#1A1A1A] border border-[#2a2a2a] text-zinc-400 rounded-xl text-sm">
