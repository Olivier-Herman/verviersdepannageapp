// src/app/api/scan-agent/route.ts
//
// GET /api/scan-agent → télécharge le paquet de l'agent Scan local (.zip).
//   Accès autorisé si :
...
//   Régénéré par : node scripts/build-scan-agent-zip.mjs
//
// Même code d'accès que l'agent eID (EID_DOWNLOAD_CODE) : c'est le même PC
// comptoir et la même personne qui installe. Olivier 2026-08-19.
