...
export default async function Page({ params }: { params: { id: string } }) {
  ...
  return (
    <AppShell title="Dossier de destruction" userRole={u.role || ''} userName={u.name || ''} userEmail={u.email || undefined} userId={u.id} userModules={u.modules || []}>
      <DossierClient id={params.id} />
    </AppShell>
  )
}
