...
function InvoiceRow({ inv, zebra }: { inv: OverdueInvoice; zebra: boolean }): React.ReactElement {
  ...
  return React.createElement(View, { style: rowStyle },
    ...
    React.createElement(Text, { style: styles.cellDue      }, inv.dueDate ? formatDate(inv.dueDate) : '—'),
    React.createElement(Text, { style: styles.cellDays     }, inv.dueDate ? `${inv.daysOverdue} j` : '—'),
  ...
  return {
    ...
    invoices: [
      { id: 1, name: 'F2026-001', invoiceDate: inv18, dueDate: due18, daysOverdue: 18, level: 1,
        amountTotal: 523.40,  amountResidual: 523.40,  isRefund: false, plate: '1-XXX-001', vehicleLabel: 'VW Golf' },
      { id: 2, name: 'F2026-014', invoiceDate: inv42, dueDate: due42, daysOverdue: 42, level: 2,
        amountTotal: 1247.80, amountResidual: 1247.80, isRefund: false, plate: '1-XXX-002', vehicleLabel: 'Renault Kangoo' },
      { id: 3, name: 'F2026-022', invoiceDate: inv73, dueDate: due73, daysOverdue: 73, level: 3,
        amountTotal: 2890.00, amountResidual: 2890.00, isRefund: false, plate: '1-XXX-003', vehicleLabel: 'Mercedes Sprinter' },
    ],
